...
exports.deleteCategorieService = void 0;
const categories_entitie_1 = __importDefault(require("../../entities/categories.entitie"));
const data_source_1 = __importDefault(require("../../data-source"));
const errors_1 = require("../../errors");
const deleteCategorieService = (name) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    if (!findCategorie) {
        throw new errors_1.AppError("Categorie não existe", 401);
    }
    if (!findCategorie.isActive) {
        throw new errors_1.AppError("Categorie não existe", 401);
    }
    yield categorieRepository.update(findCategorie.id, { isActive: false });
});
