...
exports.fixTableProduct1668803294707 = void 0;
class fixTableProduct1668803294707 {
    constructor() {
        this.name = 'fixTableProduct1668803294707';
    }
    up(queryRunner) {
        return __awaiter(this, void 0, void 0, function* () {
            yield queryRunner.query(`ALTER TABLE "products" ALTER COLUMN "price" TYPE numeric`);
            yield queryRunner.query(`ALTER TABLE "products" ALTER COLUMN "image_url" SET DEFAULT 'https://images.unsplash.com/photo-1505740420928-5e560c06d30e?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxzZWFyY2h8M3x8cHJvZHVjdHxlbnwwfHwwfHw%3D&w=1000&q=80'`);
        });
    }
    down(queryRunner) {
        return __awaiter(this, void 0, void 0, function* () {
...
exports.fixTableProduct1668803294707 = fixTableProduct1668803294707;
