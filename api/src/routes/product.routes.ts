...
import { createProductsController, deleteProductsController, updateProductsController, listProductsController, updateInventoryProductsController, listProducIdProductsController, listIdUserController } from "../controllers";
...
producsRoutes.get("/:id", listIdUserController) // list product ID ( SEM PERMISSÃO DE ADM)
